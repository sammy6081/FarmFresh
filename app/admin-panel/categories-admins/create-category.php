...
// Create Category
  ...
  if(isset($_POST["submit"])){
      if(empty($_POST['name']) OR empty($_POST['icon']) OR empty($_POST['description']) OR empty($_FILES['image']['name'])) {
            ...
            <div class="card-body">
              ...
              <form method="POST" action="create-category.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" name="description" placeholder="description" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div class="form-outline mb-4 mt-4">
                  <label>Image</label>
