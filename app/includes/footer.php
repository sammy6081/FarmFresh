<footer>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo APPURL; ?>javascript:void(0)">How it Works</a>
                        </li>
                        <li>
                ...
                <div class="col-md-3">
                     ...
                     <ul>
                         <li>
                            <a href="#"><i class="fa fa-phone"></i> 08012345678</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-envelope"></i> hello@farmfresh.com</a>
                         </li>
                     </ul>
                ...
                <div class="col-md-3">
                     ...
                     <ul class="mb-0">
                         ...
                         <li style="height: 200px">
                             <div class="mockup">
                                 <img src="<?php echo APPURL; ?>assets/img/placeholder.png">
                             </div>
                         </li>
                     </ul>
                </div>
        ...
        <p class="copyright">&copy; <?php echo date("Y"); ?> FarmFresh. All rights reserved.</p>
    </footer>
