...
<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        if(empty($_POST['name']) OR empty($_POST['lname']) OR empty($_POST['company_name']) OR empty($_POST['address']) OR empty($_POST['city']) OR empty($_POST['country'])  OR empty($_POST['zip_code']) OR empty($_POST['phone_number']) OR empty($_POST['order_notes']) ) {
            ...
            $insert = $conn->prepare("INSERT INTO orders(name, lname, company_name, address, city, country, zip_code, email, phone_number, order_notes, price, user_id)
                    ...
                    <div class="col-xs-12 col-sm-7">
                        ...
                        <form action="checkout.php" method='POST' class="bill-detail">
                            <fieldset>
                                ...
                                <button type='submit' name='submit' class="btn btn-primary float-left">PROCEED TO CHECKOUT <i class="fa fa-check"></i></button>
                                ...
                                <table class="table">
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <strong>$  <?php echo $_SESSION['price'] + 20; ?>.00</strong>
                                            </td>
                                        </tr>
                                    </tfooter>
                                </table>
