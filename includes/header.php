...
<html>
<head>
    <title>Farmfresh | Groceries Organic Store</title>
    <meta charset="utf-8">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo APPURL; ?>user/transaction.php?id=<?php echo $_SESSION['user_id']; ?>">Transactions History</a>
                                <a class="dropdown-item" href="<?php echo APPURL; ?>user/setting.php?id=<?php echo $_SESSION['user_id']; ?>">Settings</a>
